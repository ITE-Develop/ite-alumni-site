<template>
  <div class="disaster-post-wrapper">
    <div class="wrapper-inner">
      <div class="city-code d-flex justify-content-between">
        <div class="d-flex flex-wrap">
          <p class="text tags d-flex" v-for="(tag) in 5" :key="tag">
            <i class="sb-loading sb-loading-wsm sb-loading-line"></i>
          </p>
        </div>
        <p class="text time sb-loading sb-loading-wlg sb-loading-line"></p>
      </div>
      <div class="image-wrapper d-flex my-2">
        <svg class="position-relative m-auto d-block" width="84px" height="63px" x="50%" y="50%" viewBox="0 0 84 63"
          ...
          <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"
            transform="translate(-964.000000, -1012.000000)" fill-opacity="0.06">
      ...
      <p class="text text-wrap limit-text sb-loading sb-loading-line"></p>
