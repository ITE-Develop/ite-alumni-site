<template>
  <div class="row-scroll single-col-twitter">
    <div class="d-flex row-tag-twitter mx-3 justify-content-between">
      <div class="d-flex tag-wrapper flex-wrap">
        <div class="d-flex align-content-start">
          <div v-for="tag in 5" :key="tag" class="sb-loading sb-loading-wsm sb-loading-line me-1"></div>
        </div>
      </div>
      <div class="d-flex text-duration-twitter sb-loading sb-loading-line sb-loading-wmd"></div>
    </div>
    <div class="image-twitter">
      <svg class="position-relative m-auto d-block" width="84px" height="63px" x="50%" y="50%" viewBox="0 0 84 63"
        version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <!-- Generator: Sketch 48.2 (47327) - http://www.bohemiancoding.com/sketch -->
        <title>Shape</title>
        <desc>Created with Sketch.</desc>
        <defs></defs>
        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" transform="translate(-964.000000, -1012.000000)"
          fill-opacity="0.06">
    ...
    <div class="d-flex twitter-text">
      <p class="caption text-wrap limit-text sb-loading sb-loading-line"></p>
    </div>
    <div class="d-flex place mx-3 mb-2">
      <span class="text-secondary text-wrap sb-loading sb-loading-line"></span>
    </div>
    <div class="open-app">
      <div class="d-flex text-decoration-none align-items-center">
        <i class="sb-loading sb-loading-wlg sb-loading-line"></i>
      </div>
    </div>
  </div>
</template>
